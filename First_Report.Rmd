...
* In-country applications have `r summary_trends[["Apps - In Country"]][["trend_recent_vs_penultimate"]]` by `r summary_trends[["Apps - In Country"]][["pct_change_recent_vs_penultimate"]]`% to `r summary_values[["Apps - In Country - Recent"]]` in the most recent four-week period, following a `r summary_trends[["Apps - In Country"]][["trend_penultimate_vs_third_to_last"]]` of `r summary_trends[["Apps - In Country"]][["pct_change_recent_vs_penultimate"]]`% in the previous period.
